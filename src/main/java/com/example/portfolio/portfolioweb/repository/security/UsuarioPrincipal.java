 ...
 * @author Enzo
 * 
 * Esta clase se utiliza para la utilización
 */
public class UsuarioPrincipal implements UserDetails {
    
    private Long id;
    private String nombre, nombreUsuario, email, password;
    ...
    /*
        Este método se encarga de crear la lista de privilegios GrantedAuthority
        y se le asignan en el constructor al usuario principal
    */
        List<GrantedAuthority> authorities =
                //el método stream permite trabajar con colecciones. El método map permite crear una estructura apra almacenar apres clave/valor
